...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      .btn-primary{
        background-color: #2cbd4b;
        border:none;
      }
      .btn-primary:hover{
        background-color: #2ae739;
      }
      .b-example-vr {
        flex-shrink: 0;
        width: 1.5rem;
      ...
      .btn-bd-primary {
        ...
        --bs-btn-hover-bg: #2ae739;
        --bs-btn-hover-border-color: #2ae739;
        --bs-btn-focus-shadow-rgb: var(--bd-violet-rgb);
        --bs-btn-active-color: var(--bs-btn-hover-color);
        --bs-btn-active-bg: #2cbd4b;
        --bs-btn-active-border-color: #2cbd4b;
      }
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <symbol id="lab" viewBox="0 0 16 16">
    <path d="M2.5 3.5a.5.5 0 0 1 0-1h11a.5.5 0 0 1 0 1zm2-2a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1zM0 13a1.5 1.5 0 0 0 1.5 1.5h13A1.5 1.5 0 0 0 16 13V6a1.5 1.5 0 0 0-1.5-1.5h-13A1.5 1.5 0 0 0 0 6zm1.5.5A.5.5 0 0 1 1 13V6a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5z"/>
  </symbol>
  <symbol id="med-records" viewBox="0 0 16 16">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">
    <div class="d-flex align-items-center">
      <p>Care Connect</p>  
      <img class="mb-4 align-middle" src="../assets/brand/bootstrap-logo.svg" alt="" width="35" height="25">
    </div>
  </a>

  <ul class="navbar-nav flex-row ">
    <li class="nav-item text-nowrap ">
      <button class="nav-link px-3 text-white md-block" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSearch" aria-controls="navbarSearch" aria-expanded="false" aria-label="Toggle search">
  ...
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <div class="d-flex align-items-center">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Care Connect: Hospital Name</h5>
          <img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="40" height="30">
          </div>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="./patients">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#">
                <svg class="bi"><use xlink:href="#bill"/></svg>
                Billings
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#">
                <svg class="bi"><use xlink:href="#lab"/></svg>
                Lab Tests
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#">
                <svg class="bi"><use xlink:href="#med-records"/></svg>
                Medical Records
              </a>
            </li>
            <li class="nav-item">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Appointments scheduled</h1>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-6" action="/wellwell" method="post">
          <div class="input-group has-validation">
            <span class="input-group-text" id="inputGroupPrepend3">ID</span>
          ...
          <div class="input-group has-validation">
            ...
            <textarea class="form-control is-valid" aria-label="With textarea"></textarea>
          </div>
        </div>
          <div class="col-md-13">
            <label for="validationServerUsername" class="form-label"></label>
      ...
      <div class="modal-footer">
        <button type="reset" class="btn btn-danger" data-bs-dismiss="modal" onclick="">Cancel</button>
      </div>
    </div>
  </div>
</div>
