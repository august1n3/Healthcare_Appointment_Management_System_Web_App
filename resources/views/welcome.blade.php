...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
    ...
    <header class="mb-auto">
      <div>
        <div class="d-flex .align-items-end float-md-start mb-0">
          <h3>Care Connect</h3>  
          <img class="mb-4 align-middle align-self-end" src="../assets/brand/bootstrap-logo.svg" alt="" width="55" height="35">
        </div>
        <nav class="nav nav-masthead justify-content-center float-md-end">
          <a class="nav-link  py-1 px-0 active" aria-current="page" href="#">Home</a>
          <a class="nav-link  py-1 px-0" href="#Features">Features</a>
...
<main>
  <div class="px-4 pt-5 my-5 text-center">
    <h1 class="display-4 fw-bold text-body-emphasis">Healthcare Appointment Management System (SaaS)</h1>
    ...
    <div class="overflow-hidden" style="max-height: 50vh;">
      <div class="container px-5">
        <img src="bootstrap-docs.png" class="img-fluid  rounded-3  mb-4" alt="Example image" width="800" height="600" loading="eager">
      </div>
    </div>
  </div>
